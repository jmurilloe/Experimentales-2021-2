...
figure(2);clf;
plot(d,log(c),'k*',xx,yy,'m');xlabel('Espesor [mm]'); ylabel('<N>'); legend('Datos Experimentales','Ajuste Minimos Cuadrados'); title('Ajuste semilogaritmico para el decaimiento \beta');
