...
figure(2);clf;
plot(d(3:end),log(c(3:end)),'k*',xx,yy,'m');xlabel('Espesor [mm]'); ylabel('ln(<N>)'); legend('Datos Experimentales','Ajuste Minimos Cuadrados'); title('Ajuste semilogaritmico para el decaimiento \gamma')
