...
r1max = 78; r2min = 137; %<----------------------- SELECCIONAR valor maximo para la recta 1 de TIEMPO, y valor minimo para la recta 2 de TIEMPO 
n=find(t==r1max); 
...
plot (t,m,'k*')
subplot(3,1,2)
plot (x,y,'k*'); axis([0 250 195 220])   %%%%%%% <----------- SELECCIONAR rangos que concuerden con la primer grafica subplot(3,1,1)
subplot(3,1,3)
plot (x2,y2,'k*'); axis([0 250 195 220]) %%%%%%% <----------- SELECCIONAR rangos que concuerden con la primer grafica subplot(3,1,1)
