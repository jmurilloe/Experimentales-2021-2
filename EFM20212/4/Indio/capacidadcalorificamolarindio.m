...
r1max = 48; r2min = 61; %<----------------------- SELECCIONAR valor maximo para la recta 1 de TIEMPO, y valor minimo para la recta 2 de TIEMPO 
n=find(t==r1max); 
...
%%%%%%% rectas ajuste MMC
xx1=t(1):0.1:t(n); yy1=a1*xx1+b1; xx2=t(n):0.01:t(i); yy2=a1*xx2+b1;
xx3=t(n):0.01:t(i); yy3=a2*xx3+b2; xx4=t(i):0.1:t(Ns); yy4=a2*xx4+b2;
...
plot (t,m,'k*')
subplot(3,1,2)
plot (x,y,'k*'); axis([0 100 124 131])   %%%%%%% <----------- SELECCIONAR rangos que concuerden con la primer grafica subplot(3,1,1)
subplot(3,1,3)
plot (x2,y2,'k*'); axis([0 100 124 131]) %%%%%%% <----------- SELECCIONAR rangos que concuerden con la primer grafica subplot(3,1,1)
